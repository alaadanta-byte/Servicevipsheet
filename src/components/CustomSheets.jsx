...
export default function CustomSheets({ activeSheetId, setActiveSheetId }) {
    ...
    const handleFormSubmit = (e) => {
        ...
        const cleanPayload = currentSheetId === 'customers_data' ? {
            ...
            deviceType: currentSheetId === 'merchant_data' ? 'شامل' : (formData.deviceType || 'جهاز'),
        ...
        setFormData({
            ...
            duration: '',
            startDate: '',
            deviceType: currentSheetId === 'customers_data' ? '' : currentSheetId === 'merchant_data' ? 'شامل' : 'جهاز',
            paymentStatus: 'مدفوع',
            selectedAccount: '',
            invoiceNumber: '',
            visa: '',
    ...
    return (
        <div className="space-y-6 animate-fade-in font-sans pb-12">
                                ...
                                <button
                                    onClick={() => {
                                        ...
                                        setFormData({
                                            ...
                                            deviceType: isCustomersSheet ? '' : currentSheetId === 'merchant_data' ? 'شامل' : 'جهاز',
                                            paymentStatus: 'مدفوع',
                                            selectedAccount: '',
                                            invoiceNumber: '',
                                            visa: '',
            ...
            {/* Sale Status Modal (Fixed in Center of Screen - Only for account_data) */}
            {saleMenuAnchor && currentSheetId === 'account_data' && (
                <div
                    className="fixed inset-0 z-[99999] flex items-center justify-center bg-black/40 backdrop-blur-[1px] p-4"
                    onClick={() => setSaleMenuAnchor(null)}
                >
                    <div
                        onClick={(e) => e.stopPropagation()}
                        className="w-[245px] max-w-[92vw] bg-white dark:bg-slate-900 rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-700 py-1 text-right divide-y divide-slate-100 dark:divide-slate-800 ring-1 ring-black/10 select-none animate-in fade-in zoom-in-95 duration-150"
                    >
                        {/* Header */}
