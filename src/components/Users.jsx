...
export const PERMISSIONS_SECTIONS = [
    ...
    },
    {
        ...
        permissions: [
            ...
            { id: 'export_data', label: 'تصدير ونسخ البيانات', icon: 'fa-file-excel', desc: 'تصدير الشيت إلى Excel أو نسخ البيانات للحافظة' },
            { id: 'import_data', label: 'استيراد ملفات Excel', icon: 'fa-file-import', desc: 'رفع واستيراد البيانات من ملفات Excel الخارجية' },
            { id: 'customize_columns', label: 'تخصيص الأعمدة', icon: 'fa-table-columns', desc: 'إضافة أعمدة مخصصة وإعادة ترتيب أو إخفاء الأعمدة' },
...
export default function Users () {
    ...
    const handleSaveUser = async (e) => {
        ...
        try {
            ...
            const finalPermissions = (formRole === 'admin') ? ['all'] : selectedPermissions;
                                                    ...
                                                    <div className="flex flex-wrap gap-1.5 max-w-md">
                                                        ...
                                                        {userPerms.length > 3 && (
                                                            <span className="inline-flex items-center text-[10px] font-black px-2 py-0.5 rounded-lg bg-indigo-50 dark:bg-indigo-950/60 text-indigo-600 dark:text-indigo-400 border border-indigo-200 dark:border-indigo-800">
                                                                +{userPerms.length - 3} صلاحيات إضافية
                                                            </span>
                                                        )}
                                                    </div>
                                                )}
